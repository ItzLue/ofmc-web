                        ...
                        parsed: {
                            ...
                            'attackTrace': [
                                ...
                                },
                                {
                                    ...
                                    'from': '(x36,1)',
                                    'to': 'i',
                                    'payload': 'two,{NC(1),NM(2),x36,Goods(1),Price(1)}_(pk(x902))',
                                },
                                {
                                    'step': 2,
                                    'from': 'i',
                                ...
                                },
                                {
                                    ...
                                    'from': '(x901,1)',
                                    'to': 'i',
                                    'payload': 'four,{hash(x902,NC(1),NB(4),NM(2),Price(1))}_inv(pk(x901)),{NC(1),NB(4)}_(pk(x902))',
                                },
                                {
                                    'step': 4,
                                    'from': 'i',
                                ...
                                },
                                {
                                    ...
                                    'from': '(x902,1)',
                                    'to': 'i',
                                    'payload': 'five,{hash(x902,NC(1),NB(4),NM(2),Price(1))}_inv(pk(x901)),NB(4)',
                                },
                                {
                                    'step': 5,
                                    'from': 'i',
